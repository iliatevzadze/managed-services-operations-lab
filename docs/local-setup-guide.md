...
syntax checks, and offline Kubernetes manifest validation via `kubeconform`
(through Docker — no cluster or kubectl needed). Details: [cicd-guide.md](cicd-guide.md).
